...
<head>
  ...
  <title>Importler – J+T Rental</title>
...
<header class="navbar">
  ...
  <nav>
    <ul class="nav-links">
      ...
      <li><a href="importler.php" class="active">Importler</a></li>
    ...
    if (json.success) {
      ...
      bestaetigung.innerHTML = `
       <strong>${json.message}</strong><br><br>
        ...
        <a href="importler.php" style="color:#fff; text-decoration:underline;">Zurück zur Übersicht</a>
      `;
    } else {

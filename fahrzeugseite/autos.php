...
<header class="navbar">
  ...
  <nav>
    <ul class="nav-links">
      ...
      <li><a href="autos.php" class="active">Autos</a></li>
    ...
    if (json.success) {
      ...
      bestaetigung.innerHTML = `
       <strong>${json.message}</strong><br><br>
        ...
        <a href="autos.php" style="color:#fff; text-decoration:underline;">Zurück zur Übersicht</a>
      `;
    } else {
